...
Param(
    ...
    # The location/region to deploy your resources in
    [string] $resourceGrpLoc = 'westus'

)

Set-StrictMode -Version 3

$artifactStagingDir = ".\NSG-Demo-Solution"
...
$deployResourcesScriptPath = ".\NSG-Demo-Solution\NSG-Demo\Scripts\Deploy-AzureResourceGroup.ps1"
