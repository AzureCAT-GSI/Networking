...
Param(
    ...
    [string] $resourceGrpName = 'UDR-Demo'
)
...
$artifactStagingDir = ".\UDR-Demo-Solution"
...
$deployResourcesScriptPath = ".\UDR-Demo-Solution\UDR-Demo\Scripts\Deploy-AzureResourceGroup.ps1"
